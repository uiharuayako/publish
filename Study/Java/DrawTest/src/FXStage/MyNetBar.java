...
public class MyNetBar {
    ...
    public MyNetBar() {
        ...
        TableColumn toolCol = new TableColumn("工具");
        toolCol.setCellValueFactory(new PropertyValueFactory<People,String>("toolName"));
        toolCol.setMinWidth(50);
        TableColumn idCol = new TableColumn("ID");
        idCol.setCellValueFactory(new PropertyValueFactory<People,String>("ID"));
        idCol.setMinWidth(120);
        nameTable.setItems(names);
        nameTable.getColumns().addAll(nameCol,toolCol,idCol);
